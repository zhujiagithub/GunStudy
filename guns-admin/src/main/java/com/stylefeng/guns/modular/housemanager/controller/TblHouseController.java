...
public class TblHouseController extends BaseController {
    ...
    public Object list(String condition) {
        if(ToolUtil.isEmpty(condition)){
            ...
            EntityWrapper<TblHouse> wrapper = new EntityWrapper<TblHouse>();
            Wrapper<TblHouse> result = wrapper.like("house_user",condition);
            return tblHouseService.selectList(result);
        }
    }
